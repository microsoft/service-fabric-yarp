...
namespace Tests.Common
{
    ...
    public class TestMetricCreator : IMetricCreator
    {
        ...
        /// <inheritdoc/>
        public Action<long, string, string, string, string, string, string> Create(string metricName, string dimensionName1, string dimensionName2, string dimensionName3, string dimensionName4, string dimensionName5, string dimensionName6)
        {
            var slowLogger = this.Create(metricName, new[] { dimensionName1, dimensionName2, dimensionName3, dimensionName4, dimensionName5, dimensionName6 });
            return (long value, string dimension1, string dimension2, string dimension3, string dimension4, string dimension5, string dimension6) => slowLogger(value, new[] { dimension1, dimension2, dimension3, dimension4, dimension5, dimension6 });
        }
        ...
        public Action<long, string[]> Create(string metricName, params string[] dimensionNames)
        {
            ...
            // ...
            return (long value, string[] dimensions) => this.MetricsLogged.Add($"{metricName}={value};{string.Join(";", dimensionNames.Zip(dimensions).Select(((string, string) pair) => $"{pair.Item1}={pair.Item2}"))}");
        }
    }
}
