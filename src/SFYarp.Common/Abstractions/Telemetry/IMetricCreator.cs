...
namespace Yarp.ServiceFabric.Common.Abstractions.Telemetry
{
    ...
    public interface IMetricCreator
    {
        ...
        /// <summary>
        /// Creates a new metric with the provided name and 6 additional dimensions.
        /// </summary>
        Action<long, string, string, string, string, string, string> Create(string metricName, string dimensionName1, string dimensionName2, string dimensionName3, string dimensionName4, string dimensionName5, string dimensionName6);
